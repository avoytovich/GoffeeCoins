...
var AddedCoffeeHouseComponent = (function () {
    function AddedCoffeeHouseComponent(activeModal, toastrService, httpService, configs, globalDataService, coffeeHousesService, admin) {
        ...
        this.data = {
            ...
            avatarUrl: 'https://coffeecoin-dev.s3.amazonaws.com/coffeeCoins/1517475857766_coffee-house.jpg',
            admins: [],
            name: '',
            coins: 0,
            description: '',
    ...
    AddedCoffeeHouseComponent.prototype.newPosition = function (_a) {
        var lat = _a[0], lng = _a[1];
        this.data.location = [lng, lat];
    };
